...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(lightPosLoc, lightPos.x + 5.0f, lightPos.y + movelightPosY, lightPos.z + movelightPosZ );
...
//Escritorio
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0.501f, 0.392f, 0.345f);    //Color del objeto
        ...
        model = glm::mat4(1.0f);
        //model = glm::translate(model, lightPos + movelightPosY);
        model = glm::translate(model, lightPos + glm::vec3(  0.0f, movelightPosY, movelightPosZ));
